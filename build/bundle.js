...
var app = (function () {
    ...
    // (44:6) {#each mortalityCircles as d}
    function create_each_block$3(ctx) {
    	...
    	let circle_r_value;
    	let text_1;
    	let t_value = /*d*/ ctx[11].mortalityRate + "";
    	let t;
    	let text_1_transform_value;
    	...
    	const block = {
    		c: function create() {
    			...
    			text_1 = svg_element("text");
    			t = text(t_value);
    			attr_dev(circle, "class", "mortality-circle svelte-1h7qgbw");
    			attr_dev(circle, "cx", circle_cx_value = /*d*/ ctx[11].cx);
    			attr_dev(circle, "cy", circle_cy_value = /*d*/ ctx[11].cy);
    			attr_dev(circle, "r", circle_r_value = /*d*/ ctx[11].r);
    			add_location(circle, file$b, 44, 8, 1317);
    			attr_dev(text_1, "class", "mortality-labels svelte-1h7qgbw");
    			attr_dev(text_1, "transform", text_1_transform_value = "translate(" + /*d*/ ctx[11].cx + " " + (/*d*/ ctx[11].cy - /*d*/ ctx[11].r - 10) + ")");
    			add_location(text_1, file$b, 48, 8, 1444);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*mortalityCircles*/ 8 && circle_cx_value !== (circle_cx_value = /*d*/ ctx[11].cx)) {
    				attr_dev(circle, "cx", circle_cx_value);
    			}

    			if (dirty & /*mortalityCircles*/ 8 && circle_cy_value !== (circle_cy_value = /*d*/ ctx[11].cy)) {
    				attr_dev(circle, "cy", circle_cy_value);
    			}

    			if (dirty & /*mortalityCircles*/ 8 && circle_r_value !== (circle_r_value = /*d*/ ctx[11].r)) {
    				attr_dev(circle, "r", circle_r_value);
    			}

    			if (dirty & /*mortalityCircles*/ 8 && t_value !== (t_value = /*d*/ ctx[11].mortalityRate + "")) set_data_dev(t, t_value);

    			if (dirty & /*mortalityCircles*/ 8 && text_1_transform_value !== (text_1_transform_value = "translate(" + /*d*/ ctx[11].cx + " " + (/*d*/ ctx[11].cy - /*d*/ ctx[11].r - 10) + ")")) {
    				attr_dev(text_1, "transform", text_1_transform_value);
    			}
    		},
    		d: function destroy(detaching) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(44:6) {#each mortalityCircles as d}",
    		ctx
    	});
    ...
    function create_fragment$b(ctx) {
    	...
    	let each_value = /*mortalityCircles*/ ctx[3];
    	let each_blocks = [];
    	...
    	const block = {
    		c: function create() {
    			...
    			g2 = svg_element("g");
    			path = svg_element("path");
    			attr_dev(text_1, "class", "svelte-1h7qgbw");
    			add_location(text_1, file$b, 40, 6, 1168);
    			attr_dev(g0, "class", "titles svelte-1h7qgbw");
    			attr_dev(g0, "transform", g0_transform_value = "translate(0 " + /*titleHeight*/ ctx[4] + ")");
    			add_location(g0, file$b, 39, 4, 1104);
    			attr_dev(g1, "class", "mortality-circles");
    			attr_dev(g1, "transform", "translate(0 0)");
    			add_location(g1, file$b, 42, 4, 1216);
    			attr_dev(path, "class", "reduction-path svelte-1h7qgbw");
    			attr_dev(path, "d", path_d_value = /*reductionPath*/ ctx[5](/*data*/ ctx[0].slice(55, 66)));
    			add_location(path, file$b, 52, 6, 1603);
    			attr_dev(g2, "class", "reduction");
    			add_location(g2, file$b, 51, 4, 1575);
    			attr_dev(svg, "width", "100%");
    			attr_dev(svg, "height", "100%");
    			add_location(svg, file$b, 38, 2, 1067);
    			attr_dev(div, "class", "container svelte-1h7qgbw");
    			add_render_callback(() => /*div_elementresize_handler*/ ctx[10].call(div));
    			add_location(div, file$b, 37, 0, 989);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*titleHeight*/ 16 && g0_transform_value !== (g0_transform_value = "translate(0 " + /*titleHeight*/ ctx[4] + ")")) {
    				attr_dev(g0, "transform", g0_transform_value);
    			}

    			if (dirty & /*mortalityCircles*/ 8) {
    				each_value = /*mortalityCircles*/ ctx[3];
    				let i;
    			...
    			if (dirty & /*reductionPath, data*/ 33 && path_d_value !== (path_d_value = /*reductionPath*/ ctx[5](/*data*/ ctx[0].slice(55, 66)))) {
    				attr_dev(path, "d", path_d_value);
    			}
    		},
    		i: noop,
    ...
    function instance$b($$self, $$props, $$invalidate) {
    	...
    	$$self.$set = $$props => {
    		...
    		if ("scMortRate" in $$props) $$invalidate(6, scMortRate = $$props.scMortRate);
    		if ("scReduction" in $$props) $$invalidate(7, scReduction = $$props.scReduction);
    	};
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("width" in $$props) $$invalidate(1, width = $$props.width);
    		if ("height" in $$props) $$invalidate(2, height = $$props.height);
    		if ("mortalityCircles" in $$props) $$invalidate(3, mortalityCircles = $$props.mortalityCircles);
    		if ("titleHeight" in $$props) $$invalidate(4, titleHeight = $$props.titleHeight);
    		if ("xScale" in $$props) $$invalidate(8, xScale = $$props.xScale);
    		if ("yScale" in $$props) $$invalidate(9, yScale = $$props.yScale);
    		if ("reductionPath" in $$props) $$invalidate(5, reductionPath = $$props.reductionPath);
    	};
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*scMortRate, height*/ 68) {
    			 $$invalidate(3, mortalityCircles = [80, 40, 20, 10, 5].map((d, i, a) => {
    				return {
    					mortalityRate: d,
    					r: scMortRate(d),
    		...
    		if ($$self.$$.dirty & /*mortalityCircles, width*/ 10) {
    			 $$invalidate(8, xScale = linear$1().domain([0, 10]).range([
    				mortalityCircles[mortalityCircles.length - 1].cx + width / 15,
    				width - width / 20
    			]));
    		}

    		if ($$self.$$.dirty & /*data, height*/ 5) {
    			 $$invalidate(9, yScale = linear$1().domain(extent(data.map(d => d.reduction))).range([height * 2 / 3, height / 3]));
    		}

    		if ($$self.$$.dirty & /*xScale, yScale*/ 768) {
    			 $$invalidate(5, reductionPath = line().x((_, i) => xScale(i)).y(d => yScale(d.reduction)).curve(cardinal));
    		}

    		if ($$self.$$.dirty & /*height*/ 4) {
    			 $$invalidate(4, titleHeight = height * 0.1);
    		}
    	};
    ...
    class Legend extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$b, create_fragment$b, safe_not_equal, { data: 0, scMortRate: 6, scReduction: 7 });
    		...
    		if (/*scMortRate*/ ctx[6] === undefined && !("scMortRate" in props)) {
    ...
    function create_fragment$c(ctx) {
    	...
    	let if_block = /*minDim*/ ctx[12] > 0 && create_if_block$2(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span0, file$c, 60, 38, 1784);
    			attr_dev(span1, "class", "red");
    			add_location(span1, file$c, 62, 44, 1969);
    			attr_dev(div0, "class", "text");
    			add_location(div0, file$c, 59, 4, 1727);
    			attr_dev(div1, "class", "tour-title");
    			add_location(div1, file$c, 66, 6, 2165);
    			attr_dev(div2, "class", "tour-countries");
    			add_location(div2, file$c, 67, 6, 2233);
    			attr_dev(div3, "class", "tour svelte-10zobeh");
    			add_location(div3, file$c, 65, 4, 2140);
    			attr_dev(div4, "class", "intro svelte-10zobeh");
    			add_location(div4, file$c, 58, 1, 1703);
    			attr_dev(a0, "href", "https://data.unicef.org/topic/child-survival/under-five-mortality/");
    			add_location(a0, file$c, 76, 85, 2511);
    			attr_dev(div5, "class", "data-info svelte-10zobeh");
    			add_location(div5, file$c, 76, 4, 2430);
    			if (img.src !== (img_src_value = "/logo.svg")) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", "higsch-logo");
    			attr_dev(img, "class", "svelte-10zobeh");
    			add_location(img, file$c, 78, 6, 2709);
    			attr_dev(a1, "href", "https://www.linkedin.com/in/matthias-stahl/");
    			add_location(a1, file$c, 79, 33, 2784);
    			attr_dev(div6, "class", "imprint svelte-10zobeh");
    			add_location(div6, file$c, 77, 4, 2681);
    			attr_dev(div7, "class", "legend svelte-10zobeh");
    			add_location(div7, file$c, 72, 1, 2304);
    			attr_dev(div8, "class", "info svelte-10zobeh");
    			add_location(div8, file$c, 57, 0, 1683);
    			attr_dev(div9, "class", "wrapper svelte-10zobeh");
    			add_render_callback(() => /*div9_elementresize_handler*/ ctx[18].call(div9));
    			add_location(div9, file$c, 83, 0, 2889);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			mount_component(legend, div7, null);
    			append_dev(div7, t10);
    			...
    			div9_resize_listener = add_resize_listener(div9, /*div9_elementresize_handler*/ ctx[18].bind(div9));
    			current = true;
    		},
    		p: function update(ctx, [dirty]) {
