...
var app = (function () {
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(svg, file$5, 33, 0, 873);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$a(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(circle, "stroke", "none");
    			add_location(circle, file$a, 23, 2, 644);
    			attr_dev(g, "transform", g_transform_value = "translate(" + /*width*/ ctx[0] / 2 + " " + /*height*/ ctx[1] / 2 + ")");
    			add_location(g, file$a, 22, 0, 590);
    ...
    class Legend extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$b, create_fragment$c, safe_not_equal, { data: 9, scMortRate: 10, scReduction: 11 });
    ...
    function create_fragment$d(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div6 = element("div");
    			div3 = element("div");
    			div3.textContent = "How to read this chart:";
    			t9 = space();
    			...
    			add_location(span0, file$d, 61, 38, 1820);
    			attr_dev(span1, "class", "red");
    			add_location(span1, file$d, 63, 44, 2005);
    			attr_dev(div0, "class", "text svelte-19azb41");
    			add_location(div0, file$d, 60, 4, 1763);
    			attr_dev(div1, "class", "tour svelte-19azb41");
    			add_location(div1, file$d, 66, 4, 2176);
    			attr_dev(div2, "class", "intro svelte-19azb41");
    			add_location(div2, file$d, 59, 1, 1739);
    			attr_dev(div3, "class", "text svelte-19azb41");
    			add_location(div3, file$d, 74, 4, 2392);
    			attr_dev(a0, "href", "https://data.unicef.org/topic/child-survival/under-five-mortality/");
    			add_location(a0, file$d, 78, 85, 2626);
    			attr_dev(div4, "class", "data-info svelte-19azb41");
    			add_location(div4, file$d, 78, 4, 2545);
    			...
    			add_location(img, file$d, 80, 6, 2824);
    			attr_dev(a1, "href", "https://www.linkedin.com/in/matthias-stahl/");
    			add_location(a1, file$d, 81, 33, 2898);
    			attr_dev(div5, "class", "imprint svelte-19azb41");
    			add_location(div5, file$d, 79, 4, 2796);
    			attr_dev(div6, "class", "legend svelte-19azb41");
    			add_location(div6, file$d, 73, 1, 2367);
    			attr_dev(div7, "class", "info svelte-19azb41");
    			add_location(div7, file$d, 58, 0, 1719);
    			attr_dev(div8, "class", "wrapper svelte-19azb41");
    			add_render_callback(() => /*div8_elementresize_handler*/ ctx[18].call(div8));
    			add_location(div8, file$d, 85, 0, 3003);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			div8_resize_listener = add_resize_listener(div8, /*div8_elementresize_handler*/ ctx[18].bind(div8));
    			current = true;
    		},
    		p: function update(ctx, [dirty]) {
    ...
    class Flower extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$c, create_fragment$d, safe_not_equal, { data: 0, years: 1 });
