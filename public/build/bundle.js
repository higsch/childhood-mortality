...
var app = (function () {
    ...
    function create_each_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			text_1 = svg_element("text");
    			t = text(t_value);
    			attr_dev(text_1, "transform", text_1_transform_value = "translate(0 " + (-/*scYearRadius*/ ctx[3](/*year*/ ctx[4]) + Math.min(/*width*/ ctx[0], /*height*/ ctx[1]) / 30) + ")");
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*scYearRadius, years, width, height*/ 15 && text_1_transform_value !== (text_1_transform_value = "translate(0 " + (-/*scYearRadius*/ ctx[3](/*year*/ ctx[4]) + Math.min(/*width*/ ctx[0], /*height*/ ctx[1]) / 30) + ")")) {
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(line_1, file$6, 55, 4, 1677);
    			attr_dev(g, "transform", g_transform_value = "translate(" + /*width*/ ctx[0] / 2 + " " + /*height*/ ctx[1] / 2 + ")");
    			add_location(g, file$6, 44, 2, 1250);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, g, anchor);
    			append_dev(g, text_1);
    ...
    function create_each_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(text_1, file$6, 52, 6, 1561);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, text_1, anchor);
    			append_dev(text_1, t);
    ...
    function create_each_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(text_1, file$6, 60, 6, 1860);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, text_1, anchor);
    			append_dev(text_1, t);
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			g = svg_element("g");
    			attr_dev(g, "transform", g_transform_value = "translate(" + /*width*/ ctx[0] / 2 + " " + /*height*/ ctx[1] / 2 + ")");
    			add_location(g, file$7, 58, 0, 1611);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$7($$self, $$props, $$invalidate) {
    	...
    	function update(selectedIso) {
    		...
    		select(container).selectAll(".country-label").data(model).join("text").attr("class", "country-label").append("textPath").attr("href", d => `#country-label-path-${d.iso}`).attr("font-size", "1rem").attr("text-anchor", "middle").attr("startOffset", d => `${d.angle > Math.PI / 2 && d.angle < 1.5 * Math.PI
		? "75%"
    ...
    const file$b = "src/flower/Legend.svelte";
    ...
    // (35:4) {#each mortalityCircles as circle}
    function create_each_block$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			circle = svg_element("circle");
    			attr_dev(circle, "class", "mortality-circle svelte-10tdcc6");
    			attr_dev(circle, "cx", circle_cx_value = /*circle*/ ctx[10].cx);
    			attr_dev(circle, "cy", circle_cy_value = /*circle*/ ctx[10].cy);
    			attr_dev(circle, "r", circle_r_value = /*circle*/ ctx[10].r);
    			add_location(circle, file$b, 35, 6, 1003);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, circle, anchor);
    		},
    		p: function update(ctx, dirty) {
    			if (dirty & /*mortalityCircles*/ 1 && circle_cx_value !== (circle_cx_value = /*circle*/ ctx[10].cx)) {
    				attr_dev(circle, "cx", circle_cx_value);
    			}

    			if (dirty & /*mortalityCircles*/ 1 && circle_cy_value !== (circle_cy_value = /*circle*/ ctx[10].cy)) {
    				attr_dev(circle, "cy", circle_cy_value);
    			}

    			if (dirty & /*mortalityCircles*/ 1 && circle_r_value !== (circle_r_value = /*circle*/ ctx[10].r)) {
    				attr_dev(circle, "r", circle_r_value);
    			}
    		},
    		d: function destroy(detaching) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(35:4) {#each mortalityCircles as circle}",
    		ctx
    	});
    ...
    function create_fragment$b(ctx) {
    	...
    	let each_value = /*mortalityCircles*/ ctx[0];
    	let each_blocks = [];
    	...
    	const block = {
    		c: function create() {
    			...
    			g0 = svg_element("g");
    			text_1 = svg_element("text");
    			t = text("Under five-years deaths / 1,000 births");
    			g1 = svg_element("g");
    			...
    			attr_dev(text_1, "class", "svelte-10tdcc6");
    			add_location(text_1, file$b, 31, 4, 828);
    			attr_dev(g0, "class", "titles svelte-10tdcc6");
    			attr_dev(g0, "transform", g0_transform_value = "translate(0 " + /*titleHeight*/ ctx[3] + ")");
    			add_location(g0, file$b, 30, 2, 766);
    			attr_dev(g1, "class", "mortality-circles");
    			attr_dev(g1, "transform", g1_transform_value = "translate(0 " + /*titleHeight*/ ctx[3] + ")");
    			add_location(g1, file$b, 33, 2, 889);
    			attr_dev(svg, "width", /*actualWidth*/ ctx[2]);
    			attr_dev(svg, "height", /*actualHeight*/ ctx[1]);
    			add_location(svg, file$b, 29, 0, 716);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*mortalityCircles*/ 1) {
    				each_value = /*mortalityCircles*/ ctx[0];
    				let i;
    			...
    			if (dirty & /*titleHeight*/ 8 && g1_transform_value !== (g1_transform_value = "translate(0 " + /*titleHeight*/ ctx[3] + ")")) {
    				attr_dev(g1, "transform", g1_transform_value);
    			}

    			if (dirty & /*actualWidth*/ 4) {
    				attr_dev(svg, "width", /*actualWidth*/ ctx[2]);
    			}

    			if (dirty & /*actualHeight*/ 2) {
    				attr_dev(svg, "height", /*actualHeight*/ ctx[1]);
    			}
    		},
    		i: noop,
    ...
    function instance$b($$self, $$props, $$invalidate) {
    	...
    	function draw(width, height) {
    		$$invalidate(0, mortalityCircles = [100, 50, 25, 12, 6].map((d, i, a) => {
    			return {
    				mortalityRate: d,
    				r: scMortRate(d),
    	...
    	const writable_props = ["width", "height", "data", "scMortRate", "scReduction"];
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("scMortRate" in $$props) $$invalidate(7, scMortRate = $$props.scMortRate);
    		if ("scReduction" in $$props) $$invalidate(8, scReduction = $$props.scReduction);
    		if ("mortalityCircles" in $$props) $$invalidate(0, mortalityCircles = $$props.mortalityCircles);
    		if ("actualHeight" in $$props) $$invalidate(1, actualHeight = $$props.actualHeight);
    		if ("actualWidth" in $$props) $$invalidate(2, actualWidth = $$props.actualWidth);
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*width*/ 16) {
    			 $$invalidate(2, actualWidth = width - offset);
    		}

    		if ($$self.$$.dirty & /*height*/ 32) {
    			 $$invalidate(1, actualHeight = height - offset);
    		}

    		if ($$self.$$.dirty & /*actualHeight*/ 2) {
    			 $$invalidate(3, titleHeight = actualHeight / 10);
    		}

    		if ($$self.$$.dirty & /*data, width, height*/ 112) {
    			 if (data) draw();
    		}
    	};
    ...
    const file$c = "src/flower/Flower.svelte";
    ...
    function create_if_block$2(ctx) {
    	...
    	const svgvisualbelow = new SVGVisualBelow({
    			props: {
    				...
    				data: /*data*/ ctx[0],
    				years: /*years*/ ctx[1],
    				scCountryAngle: /*scCountryAngle*/ ctx[8],
    				scYearRadius: /*scYearRadius*/ ctx[9],
    				scReduction: /*scReduction*/ ctx[11],
    	...
    	const canvasvisual = new CanvasVisual({
    			props: {
    				...
    				data: /*data*/ ctx[0],
    				years: /*years*/ ctx[1],
    				scYearColor: /*scYearColor*/ ctx[7],
    				scCountryAngle: /*scCountryAngle*/ ctx[8],
    				scYearRadius: /*scYearRadius*/ ctx[9],
    				scMortRate: /*scMortRate*/ ctx[10],
    				selectedIso: /*selectedIso*/ ctx[2]
    			},
    			$$inline: true
    		});
    	...
    	svgvisualover.$on("isochanged", /*isochanged_handler*/ ctx[20]);
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*width*/ 4096) svgvisualbelow_changes.width = /*width*/ ctx[12];
    			if (dirty & /*height*/ 8192) svgvisualbelow_changes.height = /*height*/ ctx[13];
    			if (dirty & /*data*/ 1) svgvisualbelow_changes.data = /*data*/ ctx[0];
    			if (dirty & /*years*/ 2) svgvisualbelow_changes.years = /*years*/ ctx[1];
    			if (dirty & /*scCountryAngle*/ 256) svgvisualbelow_changes.scCountryAngle = /*scCountryAngle*/ ctx[8];
    			if (dirty & /*scYearRadius*/ 512) svgvisualbelow_changes.scYearRadius = /*scYearRadius*/ ctx[9];
    			if (dirty & /*scReduction*/ 2048) svgvisualbelow_changes.scReduction = /*scReduction*/ ctx[11];
    			...
    			if (dirty & /*width*/ 4096) canvasvisual_changes.width = /*width*/ ctx[12];
    			if (dirty & /*height*/ 8192) canvasvisual_changes.height = /*height*/ ctx[13];
    			if (dirty & /*data*/ 1) canvasvisual_changes.data = /*data*/ ctx[0];
    			if (dirty & /*years*/ 2) canvasvisual_changes.years = /*years*/ ctx[1];
    			if (dirty & /*scYearColor*/ 128) canvasvisual_changes.scYearColor = /*scYearColor*/ ctx[7];
    			if (dirty & /*scCountryAngle*/ 256) canvasvisual_changes.scCountryAngle = /*scCountryAngle*/ ctx[8];
    			if (dirty & /*scYearRadius*/ 512) canvasvisual_changes.scYearRadius = /*scYearRadius*/ ctx[9];
    			if (dirty & /*scMortRate*/ 1024) canvasvisual_changes.scMortRate = /*scMortRate*/ ctx[10];
    			...
    			if (dirty & /*width*/ 4096) svgvisualover_changes.width = /*width*/ ctx[12];
    			if (dirty & /*height*/ 8192) svgvisualover_changes.height = /*height*/ ctx[13];
    			if (dirty & /*data*/ 1) svgvisualover_changes.data = /*data*/ ctx[0];
    			if (dirty & /*years*/ 2) svgvisualover_changes.years = /*years*/ ctx[1];
    			if (dirty & /*scCountryAngle*/ 256) svgvisualover_changes.scCountryAngle = /*scCountryAngle*/ ctx[8];
    			if (dirty & /*scYearRadius*/ 512) svgvisualover_changes.scYearRadius = /*scYearRadius*/ ctx[9];
    			if (dirty & /*scReduction*/ 2048) svgvisualover_changes.scReduction = /*scReduction*/ ctx[11];
    			if (dirty & /*scMortRate*/ 1024) svgvisualover_changes.scMortRate = /*scMortRate*/ ctx[10];
    ...
    function create_fragment$c(ctx) {
    	...
    	let current;
    	document.body.addEventListener("click", /*click_handler*/ ctx[18]);

    	const legend = new Legend({
    			props: {
    				width: /*legendWidth*/ ctx[5],
    				height: /*legendHeight*/ ctx[6],
    				data: /*data*/ ctx[0],
    				scMortRate: /*scMortRate*/ ctx[10],
    				scReduction: /*scReduction*/ ctx[11]
    			},
    	...
    	let if_block = /*minDim*/ ctx[14] > 0 && create_if_block$2(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			div3 = element("div");
    			if (if_block) if_block.c();
    			attr_dev(span0, "class", "red svelte-1kuimsl");
    			add_location(span0, file$c, 61, 34, 1868);
    			add_location(br, file$c, 62, 45, 1952);
    			attr_dev(span1, "class", "red svelte-1kuimsl");
    			add_location(span1, file$c, 63, 42, 2056);
    			attr_dev(div0, "class", "intro svelte-1kuimsl");
    			add_render_callback(() => /*div0_elementresize_handler*/ ctx[19].call(div0));
    			add_location(div0, file$c, 60, 1, 1750);
    			attr_dev(div1, "class", "legend svelte-1kuimsl");
    			add_location(div1, file$c, 66, 1, 2219);
    			attr_dev(div2, "class", "info svelte-1kuimsl");
    			add_location(div2, file$c, 59, 0, 1730);
    			attr_dev(div3, "class", "wrapper svelte-1kuimsl");
    			add_render_callback(() => /*div3_elementresize_handler*/ ctx[21].call(div3));
    			add_location(div3, file$c, 74, 0, 2422);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*legendWidth*/ 32) legend_changes.width = /*legendWidth*/ ctx[5];
    			if (dirty & /*legendHeight*/ 64) legend_changes.height = /*legendHeight*/ ctx[6];
    			if (dirty & /*data*/ 1) legend_changes.data = /*data*/ ctx[0];
    			if (dirty & /*scMortRate*/ 1024) legend_changes.scMortRate = /*scMortRate*/ ctx[10];
    			if (dirty & /*scReduction*/ 2048) legend_changes.scReduction = /*scReduction*/ ctx[11];
    		...
    		d: function destroy(detaching) {
    			document.body.removeEventListener("click", /*click_handler*/ ctx[18]);
    			if (detaching) detach_dev(t0);
    ...
    function instance$c($$self, $$props, $$invalidate) {
    	...
    	let { years } = $$props;
    	let selectedIso;
    	let rawWidth = offset$1;
    	let rawHeight = offset$1;
    	let legendWidth = 0;
    	let legendHeight = 0;
    	let scYearColor, scCountryAngle, scYearRadius, scMortRate, scReduction;

    	function initScales(minDim) {
    		$$invalidate(7, scYearColor = ordinal().domain(years).range(["#F40000", "rgb(236, 54, 9)", "rgb(245, 120, 86)"]));
    		$$invalidate(8, scCountryAngle = ordinal().domain(data.map(d => d.iso)).range(sequence(angleOffset, 2 * Math.PI - angleOffset, (2 * Math.PI - 2 * angleOffset) / data.length)));
    		$$invalidate(9, scYearRadius = linear$1().domain([years[0], years[years.length - 1]]).range([minDim / 5, minDim / 2.4 - padding]));

    		$$invalidate(10, scMortRate = linear$1().domain([
    			0,
    			1.2 * max([].concat(...data.map(d => d.dataArr.filter(d => years.includes(d.year)).map(d => d.value))))
    		]).range([0, minDim / 9]));

    		$$invalidate(11, scReduction = linear$1().domain(extent(data.map(d => d.reduction))).range([
    	...
    	function div0_elementresize_handler() {
    		legendWidth = this.offsetWidth;
    		legendHeight = this.offsetHeight;
    		$$invalidate(5, legendWidth);
    		$$invalidate(6, legendHeight);
    	}
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("legendWidth" in $$props) $$invalidate(5, legendWidth = $$props.legendWidth);
    		if ("legendHeight" in $$props) $$invalidate(6, legendHeight = $$props.legendHeight);
    		if ("scYearColor" in $$props) $$invalidate(7, scYearColor = $$props.scYearColor);
    		...
    		if ("minDim" in $$props) $$invalidate(14, minDim = $$props.minDim);
    	};
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*rawWidth*/ 8) {
    			 $$invalidate(12, width = rawWidth - offset$1);
    		}

    		if ($$self.$$.dirty & /*rawHeight*/ 16) {
    			 $$invalidate(13, height = rawHeight - offset$1);
    		}

    		if ($$self.$$.dirty & /*width, height*/ 12288) {
    			 $$invalidate(14, minDim = Math.min(width, height));
    		}

    		if ($$self.$$.dirty & /*minDim*/ 16384) {
    			 padding = minDim / 40;
    		}
    		...
    		if ($$self.$$.dirty & /*data, years, minDim*/ 16387) {
    ...
    class Flower extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$c, create_fragment$c, safe_not_equal, { data: 0, years: 1 });
    ...
    function create_fragment$d(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div1 = element("div");
    			if (if_block) if_block.c();
    			attr_dev(h1, "class", "svelte-qjfddi");
    			add_location(h1, file$d, 31, 2, 593);
    			attr_dev(div0, "class", "header svelte-qjfddi");
    			add_location(div0, file$d, 30, 1, 570);
    			attr_dev(div1, "id", "visual");
    			attr_dev(div1, "class", "svelte-qjfddi");
    			add_location(div1, file$d, 33, 1, 630);
    			attr_dev(div2, "class", "wrapper svelte-qjfddi");
    			add_location(div2, file$d, 29, 0, 547);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
