...
var app = (function () {
    ...
    function create_each_block$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(circle, file$b, 35, 6, 1029);
    		},
    		m: function mount(target, anchor) {
    ...
    function instance$b($$self, $$props, $$invalidate) {
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*width*/ 16) {
    			 $$invalidate(2, actualWidth = Math.max(0, width - offset));
    		}

    		if ($$self.$$.dirty & /*height*/ 32) {
    			 $$invalidate(1, actualHeight = Math.max(0, height - offset));
    		}
    ...
    function create_fragment$c(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div3 = element("div");
    			if (if_block) if_block.c();
    			attr_dev(span0, "class", "red svelte-150qhb5");
    			add_location(span0, file$c, 61, 34, 1868);
    			attr_dev(span1, "class", "red svelte-150qhb5");
    			add_location(span1, file$c, 63, 42, 2047);
    			attr_dev(div0, "class", "intro svelte-150qhb5");
    			add_render_callback(() => /*div0_elementresize_handler*/ ctx[19].call(div0));
    			add_location(div0, file$c, 60, 1, 1750);
    			attr_dev(div1, "class", "legend svelte-150qhb5");
    			add_location(div1, file$c, 66, 1, 2210);
    			attr_dev(div2, "class", "info svelte-150qhb5");
    			add_location(div2, file$c, 59, 0, 1730);
    			attr_dev(div3, "class", "wrapper svelte-150qhb5");
    			add_render_callback(() => /*div3_elementresize_handler*/ ctx[21].call(div3));
    			add_location(div3, file$c, 74, 0, 2413);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$d($$self, $$props, $$invalidate) {
    	...
    	async function load() {
    		$$invalidate(0, data = await csv$1("/childhood-mortality/child_mortality.csv", d => {
    			const dataArr = [];
